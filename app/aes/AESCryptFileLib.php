...
class AESCryptFileLib
{
	...
	public function encryptContents($source_contents, $passphrase, $ext_data = NULL)
	{
		...
		return $this->doEncryptFile($source_contents, $passphrase, $ext_data);
	}
	...
	public function decryptFile($source_fh, $passphrase)
	{
		...
		$contents = $this->doDecryptFile($source_fh, $passphrase);
	...
	private function doEncryptFile($source_contents, $passphrase, $ext_data)
	{
		...
		return $header . $extdat_binary . $iv_1 . $encrypted_keys . $hmac_1 . $encrypted_file_data . $file_size_modulo . $hmac_2;
	}
	
	private function doDecryptFile($source_fh, $passphrase)
	{
